...
For Apache ZooKeeper charm the number of servers in a cluster can be easily adjusted by [adding](https://documentation.ubuntu.com/juju/latest/howto/manage-units/index.html#add-a-unit) or [removing](https://documentation.ubuntu.com/juju/latest/howto/manage-units/index.html#remove-a-unit) Juju [units](https://canonical-juju.readthedocs-hosted.com/en/latest/user/reference/unit/) from the application.
