...
class DataRelation(Object, ABC):
    ...
    def __init__(self, charm: CharmBase, relation_name: str, unique_key: Optional[str] = None) -> None:
        if not unique_key:
...
class DataPeer(DataRequires, DataProvides):
    ...
    def __init__(
        ...
        DataRequires.__init__(
            self, charm, relation_name, extra_user_roles, additional_secret_fields, unique_key=unique_key
        )
